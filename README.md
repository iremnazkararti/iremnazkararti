...
- 💡 **Zaman serisi analizi (LSTM, ARIMA, Prophet) ve sensör verisi analizi (Random Forest, XGBoost)** konularında deneyimliyim.  
- 🏆 **İki farklı yaz stajı tamamladım** ve sektörde aktif olarak projeler geliştiriyorum.  
- 📄 Akademik çalışmalarımı **konferans makalesi** olarak yayımlamayı hedefliyorum.  
